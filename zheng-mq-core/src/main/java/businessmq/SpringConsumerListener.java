...
public class SpringConsumerListener extends ConsumerListener {
    ...
    public SpringConsumerListener(final ConsumerConfig _config, AbstractConsumer abstractConsumer,ThreadPoolTaskExecutor threadPoolTaskExecutor){
        super(_config,threadPoolTaskExecutor);
